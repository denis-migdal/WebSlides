...
// change slide
let sections = [
    ...document.querySelectorAll(':is(section, uca-frame-plain)')
];
let current = 0;
...
`;
class UCAPlainFrame extends (0,_libs_LISS_index_ts__WEBPACK_IMPORTED_MODULE_0__["default"])({
    css
}) {
}
_libs_LISS_index_ts__WEBPACK_IMPORTED_MODULE_0__["default"].define("uca-frame-plain", UCAPlainFrame);
